            ...
            <ThemedView style={styles.container}>
                ...
                <View style={styles.campanhaList}>
                    ...
                    <NovaCampanhaCard
                        ...
                        // onPress={() => router.push("/(Campanha)/NovaCampanha")}
                        onPress={() => console.log("Adicionar Campanha")}
                    ...
                    <NovaCampanhaCard
                        ...
                        // onPress={() => router.push("/(Campanha)/EntrarCampanha")}
                        onPress={() => console.log("Entrar em uma Campanha")}
